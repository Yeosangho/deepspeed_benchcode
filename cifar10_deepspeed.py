...
print(f"{torch.distributed.is_initialized()}")
...
trainset = torchvision.datasets.CIFAR10(root='/scratch/hpc72a03/cifar10-data',
                                        train=True,
                                        download=True,
                                        transform=transform)
...
testset = torchvision.datasets.CIFAR10(root='/scratch/hpc72a03/cifar10-data',
                                       train=False,
                                       download=True,
                                       transform=transform)
